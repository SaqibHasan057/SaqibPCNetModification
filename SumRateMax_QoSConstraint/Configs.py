...
class TopConfig:
    def __init__(self, argv=None):
        self.function = "Train"  #  Simulation or Train or GenData
        # communication configurations
        self.user_num = 5  # number of users
        self.tx_snr = 10
        self.max_average_power = np.array([0.01 for i in range(self.user_num)])

        self.min_power_rates = np.zeros([self.user_num])
        self.min_power_rates[0] = 0.9
        self.min_power_rates[1] = 0.5
        self.min_power_rates[2] = 0.8
        self.min_power_rates[3] = 0.7
        self.min_power_rates[4] = 0.3
        ...
        self.epoch_num = 1000 # number of training epochs
        ...
        self.power_constraint_loss_scale = 10

        # simulation
        self.simu_seed = 100
        self.simutimes = 10000
        self.simu_batch_size = 10000
        self.simu_net_id_set = range(10, 11)
